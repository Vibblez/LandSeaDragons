...
var idleCheck = setInterval(function(){ var pt = document.title; if(pt.indexOf('Idle') !== -1 || pt.indexOf('(0)') !== -1){ var audio = new Audio('http://soundbible.com/mp3/chinese-gong-daniel_simon.mp3'); audio.play(); }}, 5000);
